...
import { Injectable, ApplicationRef, ComponentFactoryResolver, Injector, Input, ViewChild, HostBinding, HostListener, Component, ViewEncapsulation, ElementRef, Renderer2, EventEmitter, Output, ChangeDetectionStrategy, ViewContainerRef, ChangeDetectorRef, NgZone, NgModule, Directive, TemplateRef, ContentChild } from '@angular/core';
